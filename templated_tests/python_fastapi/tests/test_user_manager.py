...
class TestUserManager:
    ...
    def test_search_users(self, user_manager):
        user_manager.create_user("testuser1", "test1@example.com", "Test User One")
        user_manager.create_user("testuser2", "test2@example.com", "Another User")
        results = user_manager.search_users("test")
        assert len(results) == 2
        results = user_manager.search_users("another")
    ...
    def test_create_user_with_invalid_username(self, user_manager):
        invalid_user_data = {
            "username": "ab",
    ...
    def test_create_user_with_existing_username(self, user_manager, valid_user_data):
        user_manager.create_user(**valid_user_data)
